# NOTICE
```
In an attempt to make things as clean as possible, every single class will live
in it's own file. As a side effect, there will be many many files and many many
folders  with  classes in them.  I'm  doing  this to make  sure  everything  is
